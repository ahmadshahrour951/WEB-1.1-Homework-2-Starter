...
class TestApp(unittest.TestCase):
    ...
    def test_calculator_subtract(self):
        res = app.test_client().get(
            '/calculator_results?operand1=6&operand2=7&operation=subtract')
        self.assertEqual(res.status_code, 200)
    ...
    def test_calculator_multiply(self):
        res = app.test_client().get(
            '/calculator_results?operand1=6&operand2=7&operation=multiply')
        self.assertEqual(res.status_code, 200)
    ...
    def test_calculator_divide(self):
        res = app.test_client().get(
            '/calculator_results?operand1=6&operand2=3&operation=divide')
        self.assertEqual(res.status_code, 200)
    ...
    def test_compliments_3(self):
        res = app.test_client().get(
            '/compliments_results?users_name=Ducky&wants_compliments=yes&num_compliments=3')
        self.assertEqual(res.status_code, 200)
    ...
    def test_compliments_5(self):
        res = app.test_client().get(
            '/compliments_results?users_name=Moxie&wants_compliments=yes&num_compliments=5')
        self.assertEqual(res.status_code, 200)
    ...
    def test_compliments_none(self):
        res = app.test_client().get(
            '/compliments_results?users_name=Moxie&wants_compliments=no&num_compliments=3')
        self.assertEqual(res.status_code, 200)
